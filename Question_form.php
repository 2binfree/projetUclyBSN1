...
<body>
    ...
    <form class="" action="Question_form.php" method="post">
        <textarea placeholder="Ecrivez votre question ici" id="myid" class="block sizebis" name="question" required minlength="50" maxlength="500" size="50" wrap="hard"></textarea>
